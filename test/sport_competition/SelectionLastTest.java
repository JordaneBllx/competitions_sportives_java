...
public class SelectionLastTest {

    private ArrayList<League> leaguesPlayed;
    private SelectionLast selection;
	...
	public void before() {
        ...
        leagues.add(l2);
        leagues.add(l3);
        SelectionLast selection = new SelectionLast();
    ...
    public void testSelectionLast () {
        ...
        assertTrue(competitorsPhaseFinal.contains(this.c7));
        ...
        assertFalse(competitorsPhaseFinal.contains(this.c8));
    }


    // ---Pour permettre l'execution des tests ----------------------
    public static junit.framework.Test suite() {
    return new junit.framework.JUnit4TestAdapter(sport_competition.SelectionLastTest.class);
    }
